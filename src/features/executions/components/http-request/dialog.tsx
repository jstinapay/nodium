...
const formSchema = z.object({
  ...
  .regex(/^[a-zA-Z_$][a-zA-Z0-9_$]*$/, "Variable name must start with a letter, underscore, or dollar sign and can only contain letters, numbers, underscores, or dollar signs")
  ,
  endpoint: z.string()
